...
var envVars = map[string]map[string]string{
	"qa": {
		...
		// WARNING: Plaintext token for testing only. Use encrypted token for production!
		"asanaToken": "2/1208080529615858/1213164875691966:64289c8e901329b50dbf08e7c87c6d5d",
	},
	"prod": {
		//"dbHost": "todo",
	},
...
var secrets = map[string]map[string]string{
	"qa": {
		...
		// asanaToken is in envVars for QA (plaintext for testing)
	},
	"prod": {
		...
		"asanaToken":  "REPLACE_WITH_ENCRYPTED_ASANA_TOKEN_FOR_PROD", // TODO: Encrypt token using ops/encrypt.go
	},
}
